...
This project depends on `@ifood/ifds-make-kit-web-components`, `@ifood/ifdl-css-themes`, `@ifood/ifdl-fonts`, `@ifood/ifdl-icons`, `@ifood/ifds-web`, `@make-kits/ifood-playtest-make-kit` packages. Before writing
any code:
