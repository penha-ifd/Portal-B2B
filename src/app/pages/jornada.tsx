    ...
    <div className="relative">
      ...
      <div className="p-4 md:p-6 flex flex-col gap-6 md:gap-10">
        ...
        <div className="flex flex-col gap-1">
          <h1 className="text-[18px] font-medium text-[#141414] leading-6">
            Sua jornada no Comer Fora
          </h1>
          <p className="paragraph-p2-14-regular text-[#666666]">
            Cada módulo que você ativa alimenta os próximos
          </p>
        </div>
            ...
            <div key={estagio.nome} className="flex items-center flex-1">
              <div
                style={{
                  ...
                  border: `1px solid ${estagio.destaque ? "var(--atencao)" : "var(--borda)"}`,
              ...
              {i < ESTAGIOS.length - 1 && (
                <div className="flex items-center justify-center shrink-0 rotate-90 md:rotate-0" style={{ width: "32px", height: "32px" }}>
                  <svg className="w-5 h-5 text-[#A3A3A3]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        {/* Seção "O que a próxima volta destrava" */}
        <div className="flex flex-col gap-6">
          <h2 className="text-[18px] font-medium text-[#141414] leading-6">
            O que a próxima volta destrava
          </h2>
          ...
          <span style={{
            ...
            Cada módulo ativado enriquece o CRM, que melhora os insights, que aumentam o resultado.
          </span>
        </div>
        ...
        <div style={{ borderRadius: "var(--radius-12)", border: "1px solid var(--borda)", padding: "var(--spacing-16)", display: "flex", alignItems: "center", justifyContent: "space-between", backgroundColor: "transparent" }}>
          <div className="flex flex-col gap-1">
            ...
            <span style={{ fontFamily: "var(--font-inter)", fontSize: "var(--font-size-12)", fontWeight: "var(--font-weight-regular)", letterSpacing: "var(--letter-spacing)", color: "var(--text-secundario)" }}>
              Tudo que você constrói aqui — clientes, segmentos, histórico — pode ser exportado a qualquer momento, inclusive se você sair.
            </span>
          </div>
          <button type="button" style={{ border: "1px solid var(--borda)", borderRadius: "var(--radius-pill)", padding: "var(--spacing-8) var(--spacing-16)", background: "none", cursor: "pointer", fontFamily: "var(--font-inter)", fontSize: "var(--font-size-14)", fontWeight: "var(--font-weight-medium)", letterSpacing: "var(--letter-spacing)", color: "var(--text-primario)", flexShrink: 0 }}>
            Exportar base
          </button>
        </div>
      </div>
