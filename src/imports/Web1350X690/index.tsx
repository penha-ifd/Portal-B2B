import svgPaths from "./svg-0c0o9n4wno";
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative">
      ...
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['iFood_RC_Textos:Regular',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[#141414] text-[0px]">
        <p className="font-['iFood_RC_Textos:Bold',sans-serif] leading-[24px] text-[16px]">Início</p>
      </div>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="flex flex-row items-center self-stretch">
      <div className="h-full relative shrink-0 w-[276px]">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center pl-[20px] pr-[24px] py-[16px] relative size-full">
            <Frame5 />
          </div>
        </div>
      </div>
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative">
      ...
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['iFood_RC_Textos:Regular',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[#141414] text-[16px]">
        <p className="leading-[24px]">Promoções</p>
      </div>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative">
      ...
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['iFood_RC_Textos:Regular',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[#141414] text-[16px]">
        <p className="leading-[24px]">Clientes</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#f5f5f5] relative self-stretch shrink-0" data-name="Sidebar">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between pt-[8px] relative size-full">
          <div className="content-stretch flex flex-col items-center overflow-clip relative shrink-0 w-[276px]" data-name=".Sidebar item list">
            <div className="content-stretch flex h-[56px] items-center relative shrink-0 w-full" data-name=".Sidebar/Itens">
              <Frame />
            </div>
            <div className="content-stretch flex h-[56px] items-center relative shrink-0 w-full" data-name=".Sidebar/Itens">
              <Frame1 />
        ...
        <div className="content-stretch flex gap-[8px] items-center p-[8px] relative size-full">
          ...
          <div className="bg-white relative rounded-[8px] shrink-0" data-name="Button">
            <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip px-[12px] py-[8px] relative rounded-[inherit] size-full">
              <div className="[word-break:break-word] flex flex-col font-['iFood_RC_Textos:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#141414] text-[14px] whitespace-nowrap">
                <p className="leading-[16px]">Ver perfil</p>
              </div>
            </div>
...
function Frame20() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['iFood_RC_Textos:Regular',sans-serif] gap-[4px] items-center justify-center leading-[0] not-italic relative shrink-0 text-[#141414] text-[12px] whitespace-nowrap">
      ...
      <div className="flex flex-col justify-center relative shrink-0">
        <p className="leading-[16px]">100% completo</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[16px] py-[12px] relative size-full">
          <div className="bg-[#1fad68] content-stretch flex flex-col items-center justify-center overflow-clip p-[5px] relative rounded-[9999px] shrink-0 size-[16px]" data-name="Badge">
            <div className="content-stretch flex flex-col items-center justify-center pt-px relative shrink-0" data-name="icon">
        ...
        <div className="relative size-[382.086px]">
          <svg className="absolute block inset-0 size-full" fill="none" height="382.086" preserveAspectRatio="none" viewBox="0 0 382.086 382.086" width="382.086">
            <g id="Group 1597890182">
              ...
              <g id="Vector">
                <path d={svgPaths.p21fbdf00} fill="url(#paint0_linear_1_17707)" />
                <path d={svgPaths.pc52bc00} stroke="var(--stroke-0, #EFEFEF)" strokeOpacity="0.6" strokeWidth="1.88802" />
              </g>
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_17707" x1="193.654" x2="194.89" y1="77.945" y2="253.785">
...
function Group1() {
  return (
    <div className="absolute flex items-center justify-center left-[685.88px] size-[540.178px] top-[-325.11px]">
        ...
        <div className="relative size-[382.086px]">
          <svg className="absolute block inset-0 size-full" fill="none" height="382.086" preserveAspectRatio="none" viewBox="0 0 382.086 382.086" width="382.086">
            <g id="Group 1597890183">
              <circle cx="191.043" cy="191.043" fill="var(--fill-0, #F8F8F8)" id="Ellipse 847" r="191.043" />
              <g id="Vector">
                <path d={svgPaths.p1846e900} fill="url(#paint0_linear_1_17761)" />
                <path d={svgPaths.p286c1100} stroke="var(--stroke-0, #EFEFEF)" strokeOpacity="0.6" strokeWidth="1.88802" />
              </g>
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_17761" x1="175.768" x2="177.205" y1="93.003" y2="269.629">
                <stop stopColor="#EAEAEA" stopOpacity="0.1" />
                <stop offset="1" stopColor="#F7F7F7" />
              </linearGradient>
            </defs>
...
function Group3() {
  return (
    <div className="absolute contents left-[246.06px] top-[-325.11px]">
      <Group />
      <Group1 />
    </div>
  );
...
function Container1() {
  return (
    <div className="h-px relative shrink-0 w-full" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 1114 1" width="1114">
        <g id="Container">
          <g clipPath="url(#clip0_1_17656)">
            <line id="LineDivider" stroke="var(--stroke-0, #EBEBEB)" x1="4.37114e-08" x2="1114" y1="0.499952" y2="0.500049" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_1_17656">
            <rect fill="white" height="1" rx="0.5" width="1114" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function VisaoGeralNovos() {
  return (
    <div className="absolute bg-[#f5f5f5] content-stretch flex flex-col h-[1179px] items-start left-[40px] overflow-clip rounded-[24px] top-[40px] w-[1440px]" data-name="Visão geral - Novos">
      <HeaderOs />
      <Frame11 />
    </div>
  );
